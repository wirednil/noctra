        ...
        match event {
            crossterm::event::Event::Key(key_event) => match key_event.code {
                crossterm::event::KeyCode::Up => {
                    ...
                    ComponentResult {
                        event: ComponentEvent::ValueChanged(format!(
                            "{},{}",
                ...
                crossterm::event::KeyCode::Enter => ComponentResult {
                    event: ComponentEvent::Activate,
                    data: self.get_selected_row_data(),
                    completed: true,
                },
                crossterm::event::KeyCode::Esc => ComponentResult {
        ...
        match event {
            crossterm::event::Event::Key(key_event) => match key_event.code {
                crossterm::event::KeyCode::Tab => {
                    ...
                    ComponentResult {
                        event: ComponentEvent::FieldChanged(
                            self.active_field.clone().unwrap_or_default(),
                        ),
                        data: None,
                        completed: false,
                    }
